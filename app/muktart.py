...
def first_start():
    ...
    def llangtr():
        ...
        settings()
    lwindow=Tk()
    lwindow.title("First Start of Muktart")
    lwindow.config(background=bg)
    lwindow.resizable(0, 0)
    ltext1=Label(lwindow, background=bg, foreground=fg, font="arial 11 bold italic", text="Please choose a language for Muktart.\nMuktart için lütfen bir dil seçin.")
    ltext1.pack()
...
def run():
    ...
    def show():
        ...
        if os.path.isfile(en):
            ...
            text4=Label(outputs, background=bg, foreground=fg, font="arial 11 bold italic", text="\nThe output is below.\n")
    ...
    rtext3=Label(window, background=bg, foreground=fg, font="arial 11 bold italic")
    rtext3.pack() 
    ...
    if os.path.isfile(en):
        ...
        rbutton1=Button(window, font="arial 11", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, borderwidth="3", background=button_bg, text="Show results",command=show)
    elif os.path.isfile(tr):
        rtext3.config(text="Durum: Tamamlandı. Çıktı hazır.")
        rbutton1=Button(window, font="arial 11", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, borderwidth="3", background=button_bg, text="Sonuçları göster",command=show)
    rbutton1.pack()
def dae(e):
...
if os.path.isfile(en):
    ...
    label1=Label(window, background=bg, foreground=fg, font="arial 11 bold italic", text="The applications are listed below.")
    label2=Label(window, background=bg, foreground=fg, font="arial 11 bold", text="Please type a application name below.\nJust fill in the password box whenever you want to use sudo.")        
    ...
    button1=Button(window, font="arial 11", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, borderwidth="3", background=button_bg, text="Start",command=run)
    ...
    label1=Label(window, background=bg, foreground=fg, font="arial 11 bold italic", text="Aşağıda uygulamalar listelenmiştir.")
    label2=Label(window, background=bg, foreground=fg, font="arial 11 bold", text="Lütfen aşağıya bir uygulama adı yazın.\nSadece sudo kullanmak istediğiniz zamanlarda şifre kutucuğunu doldurun.")  
    appentry=Entry(window)
    ...
    passentry.bind("<FocusIn>", dpe)
    button1=Button(window, font="arial 11", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, borderwidth="3", background=button_bg, text="Başlat",command=run)   
